...
MEDIA_ROOT = 'C:/Users/fpan/lightbird/organizer/media/'
...
SECRET_KEY = 'xl)d6k0@sw)k@w!_2n)5j96ubq6a%x-2)ahf3&t(o)*j_g%5gm'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    'C:/Users/fpan/lightbird/organizer/templates',
)
